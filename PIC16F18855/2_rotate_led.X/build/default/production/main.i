...
# 68 "main.c"
    LATAbits.LATA0 = 1;
    LATAbits.LATA1 = LATAbits.LATA2 = LATAbits.LATA3 = 0;
    while (1)
    {
        static uint8_t posRotate = 1;
        if(posRotate > 8) posRotate = 1;
        LATAbits.LATA0 = posRotate & 1;
        LATAbits.LATA1 = (posRotate & 2) >> 1;
        LATAbits.LATA2 = (posRotate & 4) >> 2;
        LATAbits.LATA3 = (posRotate & 8) >> 3;
        posRotate <<= 1;;
